      ...
      >
        <DialogHeader>
          ...
          <div id="dialog-description" className="sr-only">
            Form to add a new note with title, category, and content fields.
          </div>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger
                className="w-full border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 placeholder-gray-500 dark:placeholder-gray-400 shadow-sm rounded-md focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400"
                style={{ backgroundColor: resolvedTheme === 'dark' ? '#111827' : '#ffffff' }}
              >
